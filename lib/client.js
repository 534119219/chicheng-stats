...
.dshs-panel .dshs-chips{gap:10px}
...
.dshs-panel .dshs-table-wrap{border-radius:12px;overflow:hidden}
		...
		function TrendChart({ trend }) {
			...
			return h("div", { className: "dshs-chart" },
				h("svg", { viewBox: `0 0 ${W} ${H}`, width: "100%", role: "img", "aria-label": t("trend") },
					h("defs", null,
						h("linearGradient", { id: "dshs-trend-grad", x1: "0", y1: "0", x2: "0", y2: "1" },
							h("stop", { offset: "0%", stopColor: "var(--dshs-accent,#3964fe)" }),
							h("stop", { offset: "100%", stopColor: "color-mix(in srgb,var(--dshs-accent) 45%,#ffffff)" }),
						),
					),
