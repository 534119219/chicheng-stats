...
.dshs-setcard{box-sizing:border-box;width:100%;margin:0;display:block;text-align:left;
  border:1px solid var(--dsw-alias-border-l2,#3a3f4b);background:var(--dsw-alias-bg-layer-3);
...
.dshs-mask{position:fixed;inset:0;z-index:2147482000;background:var(--dsw-alias-bg-mask-1,rgba(8,10,14,.55));backdrop-filter:blur(2px);
...
.dshs-seg{display:flex;gap:4px;padding:3px;border:1px solid var(--dsw-alias-border-l2,#3a3f4b);border-radius:10px;
  background:var(--dsw-alias-bg-layer-2,#1b202b)}
...
.dshs-seg button[data-active="true"]{background:var(--dsw-alias-button-primary-fill);color:var(--dsw-alias-label-primary-foreground)}
...
.dshs-chip{box-sizing:border-box;padding:8px 10px;border:1px solid var(--dsw-alias-border-l1,#262b36);border-radius:10px;
  background:var(--dsw-alias-bg-layer-2,#1b202b);min-width:0}
...
.dshs-model-bar{height:6px;border-radius:99px;background:var(--dsw-alias-bg-layer-1,#1b202b);overflow:hidden}
.dshs-model-bar-fill{height:100%;border-radius:99px;background:var(--dsw-alias-button-primary-fill)}
.dshs-chart{border:1px solid var(--dsw-alias-border-l1,#262b36);border-radius:10px;background:var(--dsw-alias-bg-layer-2,#1b202b);padding:8px}
...
.dshs-table th{position:sticky;top:0;background:var(--dsw-alias-bg-layer-2,#1b202b);color:var(--dsw-alias-label-secondary,#9aa3b2);
...
.dshs-error{color:var(--dsw-alias-state-error-primary);font-size:12px;padding:12px;text-align:center}
/* settings page */
...
.dshs-set-saved{font-size:12px;color:var(--dsw-alias-state-success-primary)}
...
.dshs-set-textarea{box-sizing:border-box;width:100%;padding:8px 10px;font-size:13px;color:inherit;
  background:var(--dsw-alias-bg-layer-1,#10141d);border:1px solid var(--dsw-alias-border-l2,#3a3f4b);border-radius:9px;outline:none;font-family:inherit;resize:vertical}
.dshs-set-textarea:focus{border-color:var(--dsw-alias-button-primary-fill)}
.dshs-set-ph{display:flex;gap:6px;flex-wrap:wrap}
.dshs-set-ph-chip{border:1px solid var(--dsw-alias-border-l2,#3a3f4b);background:var(--dsw-alias-bg-layer-2,#1b202b);
  color:var(--dsw-alias-label-secondary,#9aa3b2);font-size:11px;padding:3px 9px;border-radius:99px;cursor:pointer}
.dshs-set-ph-chip:hover{border-color:var(--dsw-alias-button-primary-fill);color:var(--dsw-alias-label-primary,#e6e9ef)}
.dshs-set-input{box-sizing:border-box;width:80px;padding:5px 8px;font-size:13px;color:inherit;
  background:var(--dsw-alias-bg-layer-1,#10141d);border:1px solid var(--dsw-alias-border-l2,#3a3f4b);border-radius:8px;outline:none;font-family:inherit}
.dshs-set-input:focus{border-color:var(--dsw-alias-button-primary-fill)}
.dshs-set-color{box-sizing:border-box;width:38px;height:28px;padding:2px;border:1px solid var(--dsw-alias-border-l2,#3a3f4b);
  border-radius:8px;background:var(--dsw-alias-bg-layer-1,#10141d);cursor:pointer}
...
.dshs-set-check input{accent-color:var(--dsw-alias-button-primary-fill)}
.dshs-set-unit{font-size:12px;color:var(--dsw-alias-label-tertiary,#6b7280)}
.dshs-set-preview{border:1px dashed var(--dsw-alias-border-l2,#3a3f4b);border-radius:10px;padding:10px;background:var(--dsw-alias-bg-layer-1,#1b202b)}
...
`;
		...
		function TextLine({ textSettings, data, error, onOpen }) {
			...
			if (ts.background) {
				style.background = ts.bgColor ?? "var(--dsw-alias-bg-layer-2,#1b202b)";
