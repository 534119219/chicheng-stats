...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const CSS = `
/* Theme tokens follow the dsh theme with safe light fallbacks.
...
.dshs-line:hover{background:var(--dsw-alias-interactive-bg-hover,#eceff4);color:var(--dsw-alias-label-primary,#1f2430)}
.dshs-setcard{box-sizing:border-box;width:100%;margin:0;display:block;text-align:left;
  ...
  color:var(--dsw-alias-label-primary,#1f2430);cursor:pointer}
...
.dshs-panel{box-sizing:border-box;width:min(880px,96vw);height:min(700px,92vh);display:flex;flex-direction:column;
  background:var(--dsw-alias-bg-base,#ffffff);color:var(--dsw-alias-label-primary,#1f2430);
...
.dshs-seg button:hover{color:var(--dsw-alias-label-primary,#1f2430)}
...
.dshs-btn{display:inline-flex;align-items:center;gap:6px;padding:5px 10px;border-radius:9px;border:1px solid var(--dsw-alias-border-l2,#d7dbe3);
  background:var(--dsw-alias-button-elevated-fill,#1f2430);color:var(--dsw-alias-label-primary,#1f2430);font-size:12px;cursor:pointer}
...
.dshs-section h3{margin:0 0 8px;font-size:13px;font-weight:600;color:var(--dsw-alias-label-primary,#1f2430)}
...
.dshs-table td{padding:6px 10px;border-bottom:1px solid var(--dsw-alias-border-l1,#d7dbe3);white-space:nowrap;color:var(--dsw-alias-label-primary,#1f2430)}
...
.dshs-set-ph-chip:hover{border-color:var(--dshs-focus,#639efe);color:var(--dsw-alias-label-primary,#1f2430)}
...
.dshs-set-section-title{font-size:13px;font-weight:600;color:var(--dsw-alias-label-primary,#1f2430)}
