...
.dshs-set-section{border:1px solid var(--dsw-alias-border-l1,#262b36);border-radius:12px;
  background:var(--dsw-alias-bg-l2,#1b202b);padding:12px 14px;display:flex;flex-direction:column;gap:10px}
