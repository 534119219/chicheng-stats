...
/* Dialog-only polish: clean, minimal, single-accent.
...
.dshs-panel{
  ...
  border-top:2px solid var(--dshs-accent);
...
.dshs-panel .dshs-model-bar-fill{background:var(--dshs-accent)}
...
.dshs-panel .dshs-table tr:hover td{
  background:var(--dsw-alias-interactive-bg-hover,#eef0f4)
}
.dshs-panel .dshs-filtlabel{color:var(--dsw-alias-label-secondary,#667085)}
.dshs-panel .dshs-td-total{
  color:var(--dsw-alias-label-primary,#1f2430);
  font-weight:600
}
