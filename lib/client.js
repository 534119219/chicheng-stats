...
/* Dialog-only color polish: richer surfaces + accent tints.
   Scoped to .dshs-panel so sidebar widget, hover tooltip and settings stay unchanged. */
.dshs-panel{
  background:linear-gradient(180deg,var(--dshs-surface-1) 0%,var(--dshs-surface-2) 100%);
  border-color:color-mix(in srgb,var(--dshs-accent) 18%,var(--dsw-alias-border-l2,#d7dbe3));
  box-shadow:0 24px 64px rgba(0,0,0,.45),0 0 0 1px color-mix(in srgb,var(--dshs-accent) 8%,transparent)
}
.dshs-head{
  background:linear-gradient(180deg,color-mix(in srgb,var(--dshs-accent) 12%,var(--dshs-surface-2)) 0%,var(--dshs-surface-2) 100%);
  border-bottom-color:color-mix(in srgb,var(--dshs-accent) 22%,var(--dsw-alias-border-l1,#d7dbe3))
}
.dshs-head h2{color:color-mix(in srgb,var(--dshs-accent) 75%,var(--dsw-alias-label-primary,#1f2430))}
.dshs-panel .dshs-seg{
  border-color:color-mix(in srgb,var(--dshs-accent) 20%,var(--dsw-alias-border-l2,#d7dbe3));
  background:color-mix(in srgb,var(--dshs-accent) 5%,var(--dshs-surface-2))
}
.dshs-panel .dshs-seg button[data-active="true"]{
  background:linear-gradient(180deg,var(--dshs-accent),color-mix(in srgb,var(--dshs-accent) 75%,#000));
  box-shadow:0 1px 3px rgba(57,100,254,.25)
}
.dshs-panel .dshs-btn{
  border-color:color-mix(in srgb,var(--dshs-accent) 24%,var(--dsw-alias-border-l2,#d7dbe3));
  background:linear-gradient(180deg,color-mix(in srgb,var(--dshs-accent) 10%,var(--dsw-alias-button-elevated-fill,#f4f5f7)),var(--dsw-alias-button-elevated-fill,#f4f5f7))
}
.dshs-panel .dshs-section{
  border-color:color-mix(in srgb,var(--dshs-accent) 14%,var(--dsw-alias-border-l1,#d7dbe3));
  background:color-mix(in srgb,var(--dshs-accent) 3%,var(--dshs-surface-2))
}
.dshs-panel .dshs-section h3{color:var(--dshs-accent)}
.dshs-panel .dshs-chip{
  background:linear-gradient(180deg,color-mix(in srgb,var(--dshs-accent) 7%,var(--dshs-surface-2)),var(--dshs-surface-2));
  border-color:color-mix(in srgb,var(--dshs-accent) 16%,var(--dsw-alias-border-l1,#d7dbe3));
  box-shadow:0 2px 6px rgba(0,0,0,.05)
}
.dshs-panel .dshs-chip-value{color:var(--dshs-accent)}
.dshs-panel .dshs-model-bar-fill{
  background:linear-gradient(90deg,color-mix(in srgb,var(--dshs-accent) 70%,#ffffff),var(--dshs-accent))
}
.dshs-panel .dshs-chart{
  border-color:color-mix(in srgb,var(--dshs-accent) 18%,var(--dsw-alias-border-l1,#d7dbe3));
  background:linear-gradient(180deg,color-mix(in srgb,var(--dshs-accent) 5%,var(--dshs-surface-2)),var(--dshs-surface-2))
}
.dshs-panel .dshs-table th{
  background:color-mix(in srgb,var(--dshs-accent) 10%,var(--dshs-surface-2));
  color:color-mix(in srgb,var(--dshs-accent) 70%,var(--dsw-alias-label-primary,#1f2430));
  border-bottom-color:color-mix(in srgb,var(--dshs-accent) 20%,var(--dsw-alias-border-l1,#d7dbe3))
}
.dshs-panel .dshs-table tr:hover td{
  background:color-mix(in srgb,var(--dshs-accent) 6%,var(--dsw-alias-interactive-bg-hover,#eef0f4))
}
.dshs-panel .dshs-filtlabel{color:var(--dshs-accent)}
.dshs-panel .dshs-td-total{color:var(--dshs-accent)}
.dshs-panel .dshs-empty{color:color-mix(in srgb,var(--dshs-accent) 50%,var(--dsw-alias-label-secondary,#667085))}
`;
