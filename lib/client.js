...
/* Dialog-only color polish: vivid accents + per-section hues.
   Scoped to .dshs-panel so sidebar widget, hover tooltip and settings stay unchanged. */
.dshs-panel{
  --dshs-dialog-blue:#4c8dff;
  --dshs-dialog-green:#22c55e;
  --dshs-dialog-purple:#a78bfa;
  --dshs-dialog-orange:#f59e0b;
  --dshs-dialog-cyan:#06b6d4;
  background:linear-gradient(135deg,color-mix(in srgb,var(--dshs-dialog-blue) 14%,var(--dshs-surface-1)) 0%,var(--dshs-surface-2) 55%,color-mix(in srgb,var(--dshs-dialog-purple) 10%,var(--dshs-surface-2)) 100%);
  border-color:color-mix(in srgb,var(--dshs-dialog-blue) 34%,var(--dsw-alias-border-l2,#d7dbe3));
  border-top:3px solid var(--dshs-dialog-blue);
  box-shadow:0 24px 64px rgba(0,0,0,.45),0 0 0 1px color-mix(in srgb,var(--dshs-dialog-blue) 15%,transparent)
}
.dshs-head{
  background:linear-gradient(90deg,color-mix(in srgb,var(--dshs-dialog-blue) 20%,var(--dshs-surface-2)) 0%,color-mix(in srgb,var(--dshs-dialog-purple) 14%,var(--dshs-surface-2)) 100%);
  border-bottom-color:color-mix(in srgb,var(--dshs-dialog-blue) 28%,var(--dsw-alias-border-l1,#d7dbe3))
}
.dshs-head h2{color:var(--dshs-dialog-blue)}
.dshs-panel .dshs-seg{
  border-color:color-mix(in srgb,var(--dshs-dialog-blue) 30%,var(--dsw-alias-border-l2,#d7dbe3));
  background:color-mix(in srgb,var(--dshs-dialog-blue) 9%,var(--dshs-surface-2))
}
.dshs-panel .dshs-seg button[data-active="true"]{
  background:linear-gradient(180deg,var(--dshs-dialog-blue),color-mix(in srgb,var(--dshs-dialog-blue) 70%,#000));
  box-shadow:0 2px 5px rgba(76,141,255,.35)
}
.dshs-panel .dshs-btn{
  border-color:color-mix(in srgb,var(--dshs-dialog-blue) 34%,var(--dsw-alias-border-l2,#d7dbe3));
  background:linear-gradient(180deg,color-mix(in srgb,var(--dshs-dialog-blue) 16%,var(--dsw-alias-button-elevated-fill,#f4f5f7)),var(--dsw-alias-button-elevated-fill,#f4f5f7));
  color:var(--dshs-dialog-blue)
}
.dshs-panel .dshs-section{
  --section-color:var(--dshs-dialog-blue);
  border:1px solid color-mix(in srgb,var(--section-color) 26%,var(--dsw-alias-border-l1,#d7dbe3));
  border-left:4px solid var(--section-color);
  background:linear-gradient(180deg,color-mix(in srgb,var(--section-color) 9%,var(--dshs-surface-2)),var(--dshs-surface-2));
  box-shadow:0 2px 8px rgba(0,0,0,.05)
}
.dshs-panel .dshs-section:nth-of-type(1){--section-color:var(--dshs-dialog-blue)}
.dshs-panel .dshs-section:nth-of-type(2){--section-color:var(--dshs-dialog-green)}
.dshs-panel .dshs-section:nth-of-type(3){--section-color:var(--dshs-dialog-purple)}
.dshs-panel .dshs-section:nth-of-type(4){--section-color:var(--dshs-dialog-orange)}
.dshs-panel .dshs-section h3{color:var(--section-color,var(--dshs-dialog-blue))}
.dshs-panel .dshs-chip{
  --chip-color:var(--dshs-dialog-blue);
  background:linear-gradient(180deg,color-mix(in srgb,var(--chip-color) 18%,var(--dshs-surface-2)),var(--dshs-surface-2));
  border:1px solid color-mix(in srgb,var(--chip-color) 26%,var(--dsw-alias-border-l1,#d7dbe3));
  border-left:4px solid var(--chip-color);
  box-shadow:0 2px 6px rgba(0,0,0,.06)
}
.dshs-panel .dshs-chip:nth-child(1){--chip-color:var(--dshs-dialog-blue)}
.dshs-panel .dshs-chip:nth-child(2){--chip-color:var(--dshs-dialog-green)}
.dshs-panel .dshs-chip:nth-child(3){--chip-color:var(--dshs-dialog-purple)}
.dshs-panel .dshs-chip:nth-child(4){--chip-color:var(--dshs-dialog-orange)}
.dshs-panel .dshs-chip:nth-child(5){--chip-color:var(--dshs-dialog-cyan)}
.dshs-panel .dshs-chip-label{color:color-mix(in srgb,var(--chip-color) 72%,var(--dsw-alias-label-secondary,#667085))}
.dshs-panel .dshs-chip-value{color:var(--chip-color,var(--dshs-dialog-blue))}
.dshs-panel .dshs-model-bar-fill{
  background:linear-gradient(90deg,color-mix(in srgb,var(--dshs-dialog-blue) 65%,#ffffff),var(--dshs-dialog-purple),var(--dshs-dialog-blue))
}
.dshs-panel .dshs-chart{
  border-color:color-mix(in srgb,var(--dshs-dialog-purple) 30%,var(--dsw-alias-border-l1,#d7dbe3));
  background:linear-gradient(180deg,color-mix(in srgb,var(--dshs-dialog-purple) 10%,var(--dshs-surface-2)),var(--dshs-surface-2))
}
.dshs-panel .dshs-table th{
  background:linear-gradient(180deg,color-mix(in srgb,var(--dshs-dialog-blue) 18%,var(--dshs-surface-2)),color-mix(in srgb,var(--dshs-dialog-blue) 8%,var(--dshs-surface-2)));
  color:color-mix(in srgb,var(--dshs-dialog-blue) 75%,var(--dsw-alias-label-primary,#1f2430));
  border-bottom-color:color-mix(in srgb,var(--dshs-dialog-blue) 28%,var(--dsw-alias-border-l1,#d7dbe3))
}
.dshs-panel .dshs-table tr:hover td{
  background:color-mix(in srgb,var(--dshs-dialog-blue) 10%,var(--dsw-alias-interactive-bg-hover,#eef0f4))
}
.dshs-panel .dshs-filtlabel{color:var(--dshs-dialog-blue)}
.dshs-panel .dshs-td-total{color:var(--dshs-dialog-blue)}
.dshs-panel .dshs-empty{color:color-mix(in srgb,var(--dshs-dialog-blue) 55%,var(--dsw-alias-label-secondary,#667085))}
`;
