...
.dshs-panel .dshs-donut-legend{display:flex;flex-direction:column;gap:6px;min-width:180px;flex:1}
			...
			const body = loading
				...
				: error !== null
					...
					: h(React.Fragment, null,
						...
						(data?.providers ?? []).length > 0 && h("section", { className: "dshs-section" },
