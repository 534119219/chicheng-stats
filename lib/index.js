...
function createFold(initial = {}) {
  ...
  function ingest(sessionId, event) {
    ...
    lastUsage.set(sessionId, { turn, step, day, tokens, recordIndex: records.length - 1 });
    return true;
  }
...
const _internals = { dayKey, hourKey, normalizeRange, rangeFromMs, modelOfEvent, usageOfEvent, usageTokens, createFold, scanZstdFrames, parseEventLines, decodeSessionLog, headerId, sessionsRoot, rebuildRecordsIfNeeded };
